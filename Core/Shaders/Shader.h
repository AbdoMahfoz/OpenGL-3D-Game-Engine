...
protected:
	...
	virtual void Initialize(Texture*) = 0;
	...
	virtual void BufferShadowData(GameObject&, const glm::mat4& ModelMatrix, int i);
	virtual void BufferData(GameObject&, const glm::mat4& ModelMatrix, int i) = 0;
	Shader() {};
	virtual ~Shader() {}
};
