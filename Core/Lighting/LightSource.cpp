...
{
    IsModified = true;
    LookAt = glm::vec3(0.1f, 0.0f, 0.0f);
    LightColor = glm::vec3(1.0f, 1.0f, 1.0f);
    InitializeBufferTexture(DEFAULT_SHADOW_WIDTH, DEFAULT_SHADOW_HEIGHT);
    this->ProjectionMatrix = glm::perspective(160.0f, (float)DEFAULT_SHADOW_WIDTH/DEFAULT_SHADOW_HEIGHT, 1.0f, 9.0f);
...
void LightSource::SetLookAt(const glm::vec3& LookAt)
{
    this->LookAt = LookAt;
    IsModified = true;
}
